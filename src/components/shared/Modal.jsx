...
const Modal = ({children, show = false, className, callback}) => {
    ...
    return (<>
        <AnimatePresence>
            ...
            {
                isOpen && <div className={"fixed top-1/2 right-1/2 translate-x-1/2 z-[100] -translate-y-1/2 flex justify-center items-center w-[300px] h-[400px]"}>
                    <motion.div
                        ...
                        key={"modal"}>
                        <button className={"absolute top-[8px] rounded overflow-hidden right-[8px]"} onClick={() => {setIsOpen(false); callback()}}>
